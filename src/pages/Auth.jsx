    ...
    <>
      ...
      >
        <div style={{ textAlign: 'center', padding: '0.5rem 0' }}>
          <div className="script" style={{ fontSize: '2rem', color: 'var(--ouro)', marginBottom: '1rem' }}>Sem problema!</div>
          <p style={{ fontSize: '0.9rem', lineHeight: 1.7, color: 'var(--texto)' }}>
            Entre em contato com a equipe La Provence e redefiniremos sua senha para você.
          </p>
          <a
            href="https://wa.me/5565996828577"
            target="_blank"
            rel="noreferrer"
