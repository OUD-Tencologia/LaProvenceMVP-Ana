    ...
    <section className="features-section reveal" id="diferenciais">
      <div className="features-container">
        ...
        <div className="features-grid">
          <img src={`${import.meta.env.BASE_URL}assets/img/catalog/buleFlorido.jpeg`} alt="Decor" className="fg-img main-img" />
          <img src={`${import.meta.env.BASE_URL}assets/img/catalog/Item1.png`} alt="Decor" className="fg-img overlap-img" />
        </div>
      </div>
    </section>
  );
